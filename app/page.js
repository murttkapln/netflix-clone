...
//? in next.js all components are default server components. If we want to use client components we have to use "use-client" direct.
  ...
  return (
    ...
    <div className="bg-black w-full h-full bg-opacity-60">
      <div className="text-white text-center relative top-2/4 m-auto">
        ...
        <p className="text-2axl font-[400] ">
